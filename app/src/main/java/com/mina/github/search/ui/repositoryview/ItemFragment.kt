...
import com.mina.github.databinding.FragmentRepositoriesBinding
import com.mina.github.search.ui.viewmodel.ItemViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class ItemFragment : Fragment(R.layout.fragment_repositories) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.searchRepo.observe(viewLifecycleOwner) {
